...
const EXPECTED_TYPES = {
  prb_hist_0001: { positive: [], problems: ['complete_miss', 'seller_not_recognised'], consequences: ['buyer_received_no_further_progression', 'seller_opportunity_not_developed', 'two_opportunities_present_but_not_both_progressed'], secondary_facts: [] },
  ...
  prb_hist_0003: { positive: [], problems: ['complete_miss', 'seller_not_recognised'], consequences: ['buyer_received_no_further_progression', 'seller_opportunity_not_developed', 'two_opportunities_present_but_not_both_progressed'], secondary_facts: [] },
  ...
  prb_hist_0005: { positive: ['human_response_within_16h'], problems: ['seller_not_recognised', 'buyer_not_qualified'], consequences: ['seller_opportunity_not_developed', 'response_speed_good_but_progression_weak', 'two_opportunities_present_but_not_both_progressed'], secondary_facts: [] },
  prb_hist_0006: { positive: ['human_response_within_16h'], problems: ['seller_not_recognised', 'buyer_not_progressed'], consequences: ['buyer_received_no_further_progression', 'seller_opportunity_not_developed', 'response_speed_good_but_progression_weak', 'two_opportunities_present_but_not_both_progressed'], secondary_facts: [] },
  ...
  prb_hist_0009: { positive: ['persistent_follow_up'], problems: ['seller_not_recognised', 'buyer_not_qualified'], consequences: ['seller_opportunity_not_developed', 'two_opportunities_present_but_not_both_progressed'], secondary_facts: [] },
  prb_hist_0010: { positive: [], problems: ['seller_not_recognised', 'buyer_not_progressed'], consequences: ['buyer_received_no_further_progression', 'seller_opportunity_not_developed', 'two_opportunities_present_but_not_both_progressed'], secondary_facts: [] },
  prb_hist_0011: { positive: ['concrete_buyer_next_step'], problems: ['seller_not_recognised', 'buyer_not_qualified'], consequences: ['seller_opportunity_not_developed', 'two_opportunities_present_but_not_both_progressed'], secondary_facts: [] },
