...
const STORIES = {
  silent: {
    ...
    fair_observation: '',
    main_finding: '',
    commercial_consequence: 'a £425,000 buyer enquiry went four days without anyone establishing whether I was ready to view.',
    wider_observation: "I'd also said I had a property of my own to sell that wasn't yet on the market.",
  ...
  weak: {
    ...
    wider_finding_index: 2,
    supporting_findings: '',
    fair_observation: 'you did get back to me with a call about the enquiry.',
    main_finding: 'that the call came almost 19 hours later without answering my questions or establishing my position.',
    commercial_consequence: 'you had a £225,000 buyer enquiry in front of you without knowing whether I was ready to move forward.',
    wider_observation: "I'd also said I had a property of my own to sell, but it never came up.",
  ...
  seller: {
    ...
    wider_finding_index: 2,
    supporting_findings: '',
    fair_observation: 'you followed up properly — three attempts by phone and email within a day.',
    main_finding: 'that all three attempts pushed the viewing without really establishing my position as a buyer.',
...
async function run() {
  ...
  // ── prb_hist_0003 — VARIANT 1 (no response), word for word ──
  {
    ...
    assert.strictEqual(result.email_body, [
      ...
      'That meant a £425,000 buyer enquiry went four days without anyone establishing whether I was ready to view.',
      "I'd also said I had a property of my own to sell that wasn't yet on the market.",
  ...
  // ── prb_hist_0004 — VARIANT 2, word for word ──
  {
    ...
    assert.strictEqual(result.email_body, [
      ...
      'I want to say upfront that you did get back to me with a call about the enquiry.',
      'What stood out, though, was that the call came almost 19 hours later without answering my questions or establishing my position.',
      'That meant you had a £225,000 buyer enquiry in front of you without knowing whether I was ready to move forward.',
      "I'd also said I had a property of my own to sell, but it never came up.",
  ...
  // ── prb_hist_0009 — VARIANT 2 with strong follow-up, word for word ──
  {
    ...
    assert.strictEqual(result.email_body, [
      ...
      'I want to say upfront that you followed up properly — three attempts by phone and email within a day.',
      'What stood out, though, was that all three attempts pushed the viewing without really establishing my position as a buyer.',
