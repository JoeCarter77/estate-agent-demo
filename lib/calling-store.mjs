...
export const CALLS_SCHEMA_NOTE = 'SCHEMA NOTE: one immutable row per dial. Outcome/pitched/owner_reached drive the script funnel; suppression (DO_NOT_CALL, WRONG_NUMBER) is derived from these rows, never stored on AGENCIES.';

export const CALL_MODES = Object.freeze(['MANUAL', 'TWILIO']);
export const CALL_STATUSES = Object.freeze(['queued', 'initiated', 'ringing', 'in-progress', 'completed', 'busy', 'no-answer', 'failed', 'canceled', 'manual']);
