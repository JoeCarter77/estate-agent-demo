...
export const SECTION_TRANSITIONS = Object.freeze({
  foundations: 'Okay, that gives me a good idea of where you\'re trying to get to. Just so I can understand what\'s happening underneath that, can I ask you a few questions about how things currently work across the agency — particularly how customer information gets recorded and followed up?',
  intelligence: 'Perfect. So I\'ve got a better picture of how the team currently operates. The next thing I\'m interested in is how you\'re actually finding opportunities within the enquiries and customers you\'ve already got — and whether your systems are helping you spot things that might otherwise get missed.',
  value: 'Okay, that\'s useful. I think I\'ve got a much clearer picture now. Just a couple of quick numbers before I bring everything together, so we can put some commercial context around what we\'ve discussed.',
});
...
const COMMERCIAL = [
  ...
  q({
    id: 'C1a', section: 'commercial', role: 'context', key: 'desired_outcome', type: 'text',
    ...
    primary: 'And if we were having this conversation again in six months and things had gone really well, what would have changed for you?',
    simpler: 'What would a really successful next six months look like for the agency?',
