...
export function presetEnums() {
  return Object.fromEntries(Object.values(CAMPAIGN_PRESETS).map((p) => [p.type, { label: p.label, name: p.name, sequence: p.sequence, requires_probe: p.requires_probe, cohort: p.cohort }]));
}
