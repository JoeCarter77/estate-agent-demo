...
import { PROBE_CALL_CAMPAIGN_NAME, PROBE_CALL_SCRIPT } from './probe-call-campaign.mjs';
...
const STRONG_REPLY = new Set(['POSITIVE_SEND_DEMO', 'CALL_REQUESTED', 'INFO_REQUESTED', 'POSITIVE_MEETING', 'QUESTION', 'OBJECTION']);
  ...
  for (const agency of agencies) {
    ...
    const lead = {
      ...
      context: {
        ...
        campaign_script: text(emailMeta.campaign_name || campaignsByInstantlyId.get(text(sourceReply?.campaign_id))?.name) === PROBE_CALL_CAMPAIGN_NAME ? PROBE_CALL_SCRIPT : '',
