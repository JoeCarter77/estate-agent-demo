...
export function buildFunnelMetrics(evidenceRows) {
  ...
  const positive = (e) => e.replyEvents.some((r) => ['POSITIVE_SEND_DEMO', 'CALL_REQUESTED', 'POSITIVE_MEETING'].includes(upper(r.classification)));
