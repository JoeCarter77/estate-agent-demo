...
export function rankThemes(diagnosis) {
  ...
  return THEMES.map((theme) => {
    ...
    if ((priority === 'more_valuations' || priority === 'more_buyer_demand') && theme.id === 'opportunities') score += 1.5;
    if ((priority === 'win_instructions' || priority === 'more_instructions') && theme.id === 'capture') score += 0.5;
    if (priority === 'more_instructions' && theme.id === 'progress') score += 0.5;
