...
export const CONCLUSION_STEPS = Object.freeze([
  ...
  { id: 'pilot', title: 'The founding pilot', nav: 'Pilot', blurb: '£1,500 all-in for sixty days, scope and success criteria' },
]);
...
export function presentationPayload(conclusion) {
  ...
  const screens = [
    ...
    },
    {
      ...
      cards: [
        { heading: 'Access to the relevant systems & information', sentence: 'The systems, data and permissions needed to implement your agreed NOVUS setup.' },
        { heading: 'A short setup with your team', sentence: 'Agree how opportunities are identified, who handles them and how NOVUS fits into your existing processes.' },
        { heading: 'Act on the opportunities', sentence: c.pilot.scope_rule_ids.includes('F1')
