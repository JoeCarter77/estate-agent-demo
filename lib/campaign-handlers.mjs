...
import { lockedPreset, isPresetSequence, isMatchingInstantlyPresetCampaign, presetEnums } from './campaign-presets.mjs';
  ...
  try {
    ...
    if (probeCall) {
      try {
        ...
        if (!isMatchingInstantlyPresetCampaign(preset, remoteCampaign)) throw new Error('Instantly draft copy, threading, delays or stop-on-reply setting differs from the approved version');
