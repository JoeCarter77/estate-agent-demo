...
export async function recomputeProbeObservation(repo, probeId) {
  ...
  const intelligencePatch = {
    ...
    // Confirmed present in the live INTELLIGENCE tab as of 2026-08-17, so this
    // now persists. (It previously did not exist, hence the forward-compatible
    // write — repo.appendRecord/updateById drop keys the header lacks.)
