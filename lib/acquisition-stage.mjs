...
// Canonical contact field for outreach. Do not substitute
// primary_contact_email or other_known_emails here — those are not what the
// outbound campaign actually sends to.
...
export function isProbeQueueEligible(agency) {
  return isProbeSentBlank(agency) && isEligibleForProbe(agency) && hasOutreachContactEmail(agency);
}
