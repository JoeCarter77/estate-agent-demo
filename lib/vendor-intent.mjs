...
export function computeVendorOpportunity(probe, communications) {
  ...
  if (matches.length === 0) {
    ...
    return { commPatches, status: 'no_evidence', reviewed, matches, ai_evidence_summary };
  }
  ...
  return { commPatches, status, reviewed: humanComms.length, matches, best_tag: best.tag, ai_evidence_summary };
}
