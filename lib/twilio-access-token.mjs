  ...
  const payload = {
    ...
    grants: {
      ...
      voice: {
        ...
        // Incoming too: voice-inbound.js now <Dial>s the browser identity so
        // a callback rings the open NOVUS page (lib/calling-inbound.mjs). The
        // page must Device.register() for this to take effect.
        incoming: { allow: true },
      },
    },
  };
