...
const STATUS_SYNONYMS = new Map([
  ...
  // "REVIEW" / "needs review" in the research means the pass did NOT settle on a
  // profile — every such row in the 2026-08-17 recheck has an empty URL, and its
  // notes say either "previous link was a generic page; removed" or "no
  // definitive sales-branch profile surfaced". That is 'unresolved', not
  // 'candidate': candidate asserts a likely profile exists, and here none does.
  ['needs review', RIGHTMOVE_STATUS.UNRESOLVED],
  ['review', RIGHTMOVE_STATUS.UNRESOLVED],
