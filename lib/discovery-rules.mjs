...
//   pitch_explanation, delivery_status, delivery_status_note
export const RULES = Object.freeze([
  ...
  rule({
    ...
    dependencies: [],
    answer_conditions: [{ question: 'C7', not: ['blocked'], effect: 'INFEASIBLE', note: 'Historical records are not accessible — customer context cannot be assembled within the pilot' }, { question: 'C7', not: ['unsure', 'unknown'], effect: 'ASSESS', note: 'Confirm what the CRM can export before scoping' }],
  ...
  rule({
    ...
    answer_conditions: [
      { question: 'C7', not: ['blocked'], effect: 'INFEASIBLE', note: 'Historical records are not accessible' },
  ...
  rule({
    ...
    answer_conditions: [
      { question: 'C7', not: ['blocked'], effect: 'INFEASIBLE', note: 'Historical records cannot be exported' },
