      ...
      patch.agreed_scope_json = JSON.stringify({
        ...
        conclusion: {
          ...
          project: c.project ? {
            ...
            ambition: c.project.ambition,
            components: c.project.components.map((x) => ({ id: x.id, heading: x.heading, sentence: x.sentence_polished || x.sentence, rule_ids: x.rule_ids })),
